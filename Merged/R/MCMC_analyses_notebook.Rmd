...
p_Rem_covid_MCMC_weighted <- Rem_covid_MCMC_weighted %>% plot_model_IVs_stan(variable_array = c('Covid_Exp1','Covid_Exp2'),
                                              x_range = seq(1,5,by=0.2))
p_Rem_covid_MCMC_weighted <- p_Rem_covid_MCMC_weighted + theme_bw() + 
...
p_Rem_911_MCMC_T2_weighted <- Rem_911_MCMC_T2_weighted %>% plot_model_IVs_stan(variable_array = c('prev_experience','curr_experience'),
                                              x_range = seq(1,5,by=0.2))
p_Rem_911_MCMC_T2_weighted <- p_Rem_911_MCMC_T2_weighted + theme_bw() + 
  ylab('Remembered Stress (Squeezed into 0-1)') +
  xlab('Self-reported Stress') +
  scale_color_manual(labels = c('T1 experienced','T2 current'), values = c('purple','green'))+
  scale_fill_manual(values = c('purple','green'))+
